    ...
    use libuif
      ...
      type(uiDrawMatrix) :: m
        ...
        transformsp%DashPhase = 0
          ...
          path = uiDrawNewPath(uiDrawFillModeWinding)
          call uiDrawPathAddRectangle(path, 126.0d0, 80.5d0, 186.0d0 - 126.0d0, 140.5d0 - 80.5d0)
          call uiDrawPathEnd(path)
...
!	// TODO this needs to be dashed
          ...
          call uiDrawMatrixTranslate(m, 20.0d0, 10.0d0)
  ...
  end subroutine drawD2DTranslate
